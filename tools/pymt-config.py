...
e_pymt_loglevel = Listbox(g_pymt, height=5, exportselection=0)
...
Label(g_graphics, text='Display').grid(row=3)
Label(g_graphics, text='Polygon smooth').grid(row=4)
Label(g_graphics, text='Line smooth').grid(row=5)
Label(g_graphics, text='Vertical sync').grid(row=6)
Label(g_graphics, text='FBO').grid(row=7)
...
e_graphics_display = Entry(g_graphics, textvariable=c['graphics.display'])
...
e_graphics_fbo = Listbox(g_graphics, height=2, exportselection=0)

e_graphics_fullscreen.grid(row=0, column=1)
e_graphics_width.grid(row=1, column=1)
e_graphics_height.grid(row=2, column=1)
e_graphics_display.grid(row=3, column=1)
e_graphics_polygon_smooth.grid(row=4, column=1)
e_graphics_line_smooth.grid(row=5, column=1)
e_graphics_vertical_sync.grid(row=6, column=1)
e_graphics_fbo.grid(row=7, column=1)
...
e_modules_list = Listbox(g_modules, selectmode=MULTIPLE, exportselection=0)
...
e_input_ip = Entry(g_input, textvariable=tuio_host)
e_input_port = Entry(g_input, textvariable=tuio_port)
...
# Fill list
# ================================================================
e_graphics_fbo.insert(END, 'hardware')
e_graphics_fbo.insert(END, 'software')
e_pymt_loglevel.insert(END, 'debug')
e_pymt_loglevel.insert(END, 'info')
e_pymt_loglevel.insert(END, 'warning')
e_pymt_loglevel.insert(END, 'error')
