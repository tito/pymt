...
class KeyboardLayoutQWERTY(KeyboardLayout):
    ...
    NORMAL_1 = [
        ...
        ('=', '=', None, 1),    ('\u232b', None, 'backspace', 2),
    ]
    NORMAL_2 = [
        ('\u21B9', chr(0x09), None, 1.5),  ('q', 'q', None, 1),    ('w', 'w', None, 1),
    ...
    NORMAL_3 = [
        ('\u21ea', None, 'capslock', 1.8),  ('a', 'a', None, 1),    ('s', 's', None, 1),
    ...
    NORMAL_4 = [
        ('\u21e7', None, 'shift_L', 2.5),  ('z', 'z', None, 1),    ('x', 'x', None, 1),
        ('c', 'c', None, 1),    ('v', 'v', None, 1),    ('b', 'b', None, 1),
        ('n', 'n', None, 1),    ('m', 'm', None, 1),    ('<', '<', None, 1),
        ('>', '>', None, 1),    ('?', '?', None, 1),    ('\u21e7', None, 'shift_R', 2.5),
    ]
    NORMAL_5 = [
        (' ', ' ', None, 12), ('\u2b12', None, 'layout', 1.5), ('\u2a2f', None, 'escape', 1.5),
...
class KeyboardLayoutAZERTY(KeyboardLayout):
    ...
    SIZE            = (15, 5)
    NORMAL_1 = [
        ('@', '@', None, 1),    ('&', '&', None, 1),    ('\xe9', '\xe9', None, 1),
        ('"', '"', None, 1),    ('\'', '\'', None, 1),  ('(', '(', None, 1),
        ('-', '-', None, 1),    ('\xe8', '\xe8', None, 1),    ('_', '_', None, 1),
        ('\xe7', '\xe7', None, 1),    ('\xe0', '\xe0', None, 1),    (')', ')', None, 1),
        ('=', '=', None, 1),    ('\u232b', None, 'backspace', 2),
    ]
    NORMAL_2 = [
        ('\u21B9', chr(0x09), None, 1.5),  ('a', 'a', None, 1),    ('z', 'z', None, 1),
        ('e', 'e', None, 1),    ('r', 'r', None, 1),    ('t', 't', None, 1),
        ('y', 'y', None, 1),    ('u', 'u', None, 1),    ('i', 'i', None, 1),
        ('o', 'o', None, 1),    ('p', 'p', None, 1),    ('^', '^', None, 1),
        ('$', '$', None, 1),    ('\u23ce', None, 'enter', 1.5),
    ]
    NORMAL_3 = [
        ('\u21ea', None, 'capslock', 1.8),  ('q', 'q', None, 1),    ('s', 's', None, 1),
        ('d', 'd', None, 1),    ('f', 'f', None, 1),    ('g', 'g', None, 1),
        ('h', 'h', None, 1),    ('j', 'j', None, 1),    ('k', 'k', None, 1),
        ('l', 'l', None, 1),    ('m', 'm', None, 1),    ('\xf9', '\xf9', None, 1),
        ('*', '*', None, 1),    ('\u23ce', None, 'enter', 1.2),
    ]
    NORMAL_4 = [
        ('\u21e7', None, 'shift_L', 1.5),  ('<', '<', None, 1),    ('w', 'w', None, 1),
        ('x', 'x', None, 1),
        ('c', 'c', None, 1),    ('v', 'v', None, 1),    ('b', 'b', None, 1),
    ...
    * shift_R
    ...
    def _do_update(self, mode=None):
        ...
        if mode == 'background':
            s = 1.
            w, h = self.size
        mtop, mright, mbottom, mleft = [x * s for x in self.style['margin']]
