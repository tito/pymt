...
class MTTrajectory(MTWidget):
    ...
    def on_touch_down(self, touches, touchID, x, y):
        self.trajectory_dict[touchID] = []
            
    def on_touch_move(self, touches, touchID, x, y):
        self.trajectory_dict[touchID].append((x,y))
    
    def on_touch_up(self, touches, touchID, x, y):
        self.trajectory_dict_compiled[touchID] = GlDisplayList()
        with self.trajectory_dict_compiled[touchID]:
            self.draw_trajectory(self.trajectory_dict[touchID], self.close)
